...
# Indian and Global Financial News Sources
INDIAN_NEWS_SOURCES = {
    'moneycontrol': {
        'name': 'Moneycontrol',
    ...
    'reuters_india': {
        ...
        'news_urls': [
            'https://in.reuters.com/finance/markets',
            'https://in.reuters.com/business/companies',
            'https://in.reuters.com/business/markets'
        ],
        'selectors': {
            'headlines': 'h2 a, h3 a',
            'content': 'div.ArticleBody__content___2gQno',
            'date': 'time',
            'author': '.BylineBar_byline'
        }
    },
    'yahoo_finance': {
        'name': 'Yahoo Finance',
        ...
        'news_urls': [
            ...
            'https://finance.yahoo.com/topic/india/',
    ...
    'bloomberg_markets': {
        ...
        'selectors': {
            'headlines': 'h1 a, h2 a, h3 a',
            'content': 'div.body-copy-v2',
            'date': 'time',
            'author': '.author'
        }
    },
    'cnbc_markets': {
        ...
        'news_urls': [
            ...
            'https://www.cnbc.com/india/'
        ],
        'selectors': {
            'headlines': 'a.Card-title, h2 a',
    ...
    'investing_com': {
        ...
        'news_urls': [
            ...
            'https://in.investing.com/news/economy',
            'https://in.investing.com/news/commodities-news'
        ],
        'selectors': {
            'headlines': 'article a.title',
            'content': 'div.WYSIWYG.articlePage',
            'date': 'span.articleDetails span',
    ...
    'screener_in': {
        ...
        'news_urls': [
            'https://www.screener.in/news/',
        ],
        'selectors': {
            'headlines': 'h2 a, h3 a',
            'content': 'div.card-body, .content',
            'date': 'span.date, time',
            'author': 'span.author'
        }
    }
...
# RSS Feeds for News - Updated with more reliable sources
RSS_FEEDS = {
    ...
    'feeds_reuters': 'https://feeds.reuters.com/reuters/businessNews',
    'yahoo_finance_rss': 'https://feeds.finance.yahoo.com/rss/2.0/headline',
